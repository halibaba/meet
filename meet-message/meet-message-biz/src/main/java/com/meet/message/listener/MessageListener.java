package com.meet.message.listener;

import com.meet.message.handler.MeetSocketHandler;
...
public class MessageListener {
	...
	@Autowired
	private MeetSocketHandler meetSocketHandler;
	...
	public void listenZhugeGroup(ConsumerRecord<String, String> record, Acknowledgment ack) {
		...
		meetSocketHandler.sendMessage("123456", value);
		//手动提交offset
		ack.acknowledge();
